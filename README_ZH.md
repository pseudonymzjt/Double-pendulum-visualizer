...
- **精确物理引擎**：采用精确拉格朗日力学的 RK4 积分，支持 N 节摆链模拟。
...
**物理引擎**：基于精确拉格朗日力学的 RK4 积分，每帧 4 个子步长。N×N 质量矩阵通过高斯消元法求解，包含完整的三角耦合项（无小角度近似）。动能、势能和总能实时计算并可视化，总能守恒精度达小数点后四位。
